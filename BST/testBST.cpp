...
int main() {
    ...
    //This is a duplicate entry & shouldn't get inserted. So, size should still be 5.
    //v.push_back(105);
    ...
    /* Test find return value. */
    // Test an item that is not in the tree
    if(!b.find(7)) {
            cout << "The following value do not exist in the tree: " << 7 << endl;
    }

    /* Test height */
    cout<< "The height of BST is: "<<b.height()<<endl;

    /* Test if tree is empty */
    if(b.empty()) {
    	cout<<"The BST is empty! Please insert some items!"<<endl;
    }
    else {
    	cout<<"The BST is NOT empty"<<endl;
    }
