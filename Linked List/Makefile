...
backup:	*.h *.c Makefile
	cp *.[ch] Makefile $(HOME)/hw5/backup
...
public:
	...
	cp .cproject .project .hw5.sln .hw5.vcproj Makefile \
	*.empty *.c *.h driver1 driver2 calc $(DIR)
	...
	#
	#scp -p Makefile *.[ch] cs12xzz@ieng6-201:~/hw5
